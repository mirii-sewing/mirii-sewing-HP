...
(async () => {
    ...
    try {
        ...
        await page.goto('https://mirii-sewing.online/wp-admin/'); // Use wp-admin to get nonce easily
...
.btn-mirii-pink { background: var(--mirii-pink-dark) !important; color: #fff !important; border-radius: 50px !important; padding: 16px 40px !important; font-weight: bold; text-decoration: none; display: inline-block; transition: 0.3s; border: none; text-align: center; font-size: 1rem; }
.btn-mirii-green { background: var(--mirii-green-line) !important; color: #fff !important; border-radius: 50px !important; padding: 16px 40px !important; font-weight: bold; text-decoration: none; display: inline-block; transition: 0.3s; border: none; text-align: center; font-size: 1rem; }
.btn-mirii-outline { background: #fff !important; color: var(--mirii-text) !important; border: 1px solid var(--mirii-border) !important; border-radius: 50px !important; padding: 14px 38px !important; font-weight: bold; text-decoration: none; display: inline-block; transition: 0.3s; text-align: center; }
...
/* Hide Blog Elements */
.entry-title, .post-meta, .sns-share, .sns-follow, .author-info, .post-date, .post-update, .toc, .article-header, .article-footer, #sidebar, .breadcrumb { display: none !important; }
#main { width: 100% !important; max-width: 100% !important; padding: 0 !important; margin: 0 !important; }
.article { border: none !important; background: transparent !important; padding: 0 !important; }
.entry-content { margin-top: 0 !important; }
        ...
        // Top Page (18: HOME New)
        const html_home = globalCSS + \`
...
<h2 class="has-text-align-center font-mincho" style="color:#fff; font-size:clamp(1.5rem, 5vw, 2.5rem); line-height:1.6; text-shadow:0 3px 6px rgba(0,0,0,0.4);">ミシンで紡ぐ、<br>ママと子供の愛おしい時間</h2>
...
<!-- /wp:group -->
<p class="has-text-align-center font-mincho" style="font-size: clamp(1.2rem, 3vw, 2.0rem); color:#fff; text-shadow: 0 2px 4px rgba(0,0,0,0.3); margin-top:20px;">たった1回で「私にもできた」を実感できる</p>
<h1 class="has-text-align-center font-mincho" style="font-size: clamp(2.5rem, 8vw, 4.5rem); color:#fff; margin-top:0.2em; text-shadow: 0 2px 4px rgba(0,0,0,0.3);">1Day体験レッスン</h1>
</div>
<!-- /wp:group --></div></div>
<!-- /wp:cover -->
...
<div class="section-bg-pink" style="padding:80px 40px; max-width:1000px; margin:0 auto;">
<h2 class="has-text-align-center font-mincho">体験後にどう変わるか</h2>
<div style="max-width:600px; margin: 40px auto 0;">
<p style="margin-bottom:15px;">✔ ミシンへの恐怖心が消え、「私にもできる！」という自信が持てるようになります。</p>
<p style="margin-bottom:15px;">✔ お家でミシンを出すのが、「億劫な時間」から「楽しみな時間」に変わります。</p>
...
<div style="margin-top:60px; display:grid; grid-template-columns: 1fr 1fr; gap:40px;">
  <div>
    ...
    <h4 class="font-mincho" style="margin-top:20px;">A. 裏地付きワンピース</h4><p>初心者でも綺麗に仕上がる基礎を学びます。そのままお出かけに着ていける上品なデザインです。</p>
  </div>
  <div>
    <img src="\${images.work_b}" style="width:100%; border-radius:12px; aspect-ratio:1/1; object-fit:cover;"/>
    <h4 class="font-mincho" style="margin-top:20px;">B. 男の子用パンツ</h4><p>カーブの縫い方やウエストゴムの基本を学びます。活発な男の子でも動きやすい定番の形です。</p>
  </div>
</div>
</div>
...
<h1 class="has-text-align-center font-mincho" style="font-size: clamp(2.5rem, 8vw, 4rem); color:#fff; margin-top:0.2em; text-shadow:0 2px 4px rgba(0,0,0,0.3);">はじめての方へ</h1>
</div>
<!-- /wp:group --></div></div>
<!-- /wp:cover -->
...
\`;
        ...
        await page.screenshot({ path: '/Users/ayumi/.gemini/antigravity/brain/b3195448-d29e-4066-a535-3f07e06d8a74/brand_v2_home.png', fullPage: true });
        await page.goto('https://mirii-sewing.online/1day-lesson/', { waitUntil: 'load' });
        await page.screenshot({ path: '/Users/ayumi/.gemini/antigravity/brain/b3195448-d29e-4066-a535-3f07e06d8a74/brand_v2_1day.png', fullPage: true });
        await page.goto('https://mirii-sewing.online/welcome/', { waitUntil: 'load' });
        await page.screenshot({ path: '/Users/ayumi/.gemini/antigravity/brain/b3195448-d29e-4066-a535-3f07e06d8a74/brand_v2_welcome.png', fullPage: true });
