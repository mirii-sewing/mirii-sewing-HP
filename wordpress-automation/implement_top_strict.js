...
<div class="wp-block-cover alignfull" style="min-height:95vh;">
    ...
    <img class="wp-block-cover__image-background" src="${images.fv_top}" data-object-fit="cover"/>
    <div class="wp-block-cover__inner-container">
        ...
        <div class="wp-block-group">
            ...
            <p class="has-text-align-center" style="color:#fff; font-size:1.1rem;">未経験から、ひとりで子ども服が作れるようになる。<br>初心者さんのための、少人数制ミシン教室です。</p>
            <div style="height:40px;"></div>
            <div style="text-align:center;"><a href="/1day-lesson/" class="btn-mirii-primary">1Day体験レッスンの詳細を見る</a></div>
        </div>
        <!-- /wp:group -->
    </div>
</div>
...
<div class="brand-section">
    <div style="max-width:850px; margin:0 auto; text-align:left;">
        <h2 class="brand-title" style="text-align:center !important;">ミシンを買ったものの、箱の中に眠らせていませんか？</h2>
        ...
        <div style="height:40px;"></div>
        <div style="text-align:center;"><a href="/welcome/" class="btn-mirii-tertiary">はじめての方へ</a></div>
    </div>
</div>

<div class="section-bg-beige brand-section">
    <div style="max-width:950px; margin:0 auto;">
        <h2 class="brand-title">はじめてでも、少しずつ身につく理由があります</h2>
        <div style="display:grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap:40px; margin-top:50px;">
            <div>
                <h4 style="font-size:1.3rem; margin-bottom:15px; border-left:3px solid var(--mirii-pink-dark); padding-left:15px;">順序立てて学べるから、迷いません</h4>
                <p>何から始めればいいか分からない状態でも大丈夫です。服作りに必要な流れを、一つずつ整理しながら進めていきます。</p>
            </div>
            <div>
                <h4 style="font-size:1.3rem; margin-bottom:15px; border-left:3px solid var(--mirii-pink-dark); padding-left:15px;">縫う前の準備から、丁寧にお伝えします</h4>
                <p>きれいに仕上がるかどうかは、縫い方だけでは決まりません。生地の扱い方や裁断など、最初の準備から大切にしています。</p>
            </div>
            <div>
                <h4 style="font-size:1.3rem; margin-bottom:15px; border-left:3px solid var(--mirii-pink-dark); padding-left:15px;">お家でも続けられることを大切にしています</h4>
                <p>教室で完成することよりも、お家でも自分で作れるようになること を大切にしています。分からないまま置いていかないレッスンです。</p>
            </div>
        </div>
...
<div class="brand-section">
    <div style="max-width:850px; margin:0 auto; text-align:left;">
        <h2 class="brand-title" style="text-align:center !important;">まずは、1回の体験から始めてみませんか？</h2>
...
<div class="section-bg-beige brand-section">
    <div style="max-width:850px; margin:0 auto;">
        <h2 class="brand-title">基礎からしっかり身につけたい方へ</h2>
        ...
        <div style="height:40px;"></div>
        <div style="text-align:center;"><a href="/course/" class="btn-mirii-tertiary">4ヶ月少人数コースを見る</a></div>
    </div>
</div>
...
<div class="brand-section">
    <div style="max-width:900px; margin:0 auto; display:flex; align-items:center; gap:50px; flex-wrap:wrap;">
        <div style="flex:1; min-width:300px; text-align:center;">
            <img src="${images.profile}" class="brand-img" style="border-radius:50%; width:250px; aspect-ratio:1/1; object-fit:cover;"/>
        </div>
...
<div class="section-bg-pink brand-section" style="text-align:center; padding:100px 24px;">
    <div style="max-width:850px; margin:0 auto;">
        <h2 class="brand-title">まずは、体験レッスンかLINE登録からどうぞ</h2>
        ...
        console.log("Top Page Update Complete (Strict Draft).");
