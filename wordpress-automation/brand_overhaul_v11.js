...
(async () => {
    ...
    try {
        ...
        console.log("Injecting Global CSS v11 (Final Polish)...");
        ...
        const css = '/* --- Mirii Sewing Brand Guidelines v11 --- */' +
            ':root {' +
            ...
            '/* Button Hierarchy */' +
            '/* PRIORITY 1: 1Day Lesson / Main Action */' +
            '.btn-mirii-primary { background: var(--mirii-pink-dark) !important; color: #fff !important; border-radius: 50px !important; padding: 18px 50px !important; font-weight: bold; text-decoration: none; display: inline-block; text-align: center; box-shadow: 0 4px 15px rgba(216, 174, 183, 0.4); transition: all 0.3s; border: none !important; font-size: 1.1rem; }' +
            '.btn-mirii-primary:hover { transform: translateY(-2px); box-shadow: 0 6px 20px rgba(216, 174, 183, 0.5); opacity: 0.95; }' +
            '/* PRIORITY 2: LINE Registration */' +
            '.btn-mirii-secondary { background: var(--mirii-green) !important; color: #fff !important; border-radius: 50px !important; padding: 16px 45px !important; font-weight: bold; text-decoration: none; display: inline-block; text-align: center; box-shadow: 0 4px 12px rgba(127, 174, 155, 0.3); transition: all 0.3s; border: none !important; }' +
            '.btn-mirii-secondary:hover { transform: translateY(-2px); box-shadow: 0 6px 18px rgba(127, 174, 155, 0.4); opacity: 0.95; }' +
            '/* PRIORITY 3: Details / Outline / Navigation */' +
            '.btn-mirii-tertiary { background: #fff !important; color: var(--mirii-text) !important; border: 1px solid var(--mirii-border) !important; border-radius: 50px !important; padding: 14px 40px !important; font-weight: bold; text-decoration: none; display: inline-block; text-align: center; transition: all 0.3s; font-size: 0.95rem; }' +
            '.btn-mirii-tertiary:hover { background: var(--mirii-bg-beige) !important; border-color: var(--mirii-pink-dark) !important; }' +
            '/* Badges */' +
            '.badge-mirii { background: var(--mirii-pink-soft) !important; color: var(--mirii-pink-dark) !important; padding: 6px 18px; border-radius: 30px; font-size: 0.85rem; font-weight: bold; margin: 4px; display: inline-block; }' +
            '/* Sections & Images */' +
            ...
            '.brand-title { margin-bottom: 45px; line-height: 1.6; font-size: 2rem; }' +
            '/* Kill Heading Counters */' +
