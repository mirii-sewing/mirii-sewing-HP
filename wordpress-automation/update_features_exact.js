...
<div class="wp-block-group" style="background-color:#FCF7F8; padding: 80px 20px; text-align:center; border-bottom: 1px solid #E9E6E4; margin-bottom:50px;">
...
<!-- wp:button -->
<div class="wp-block-button"><a class="wp-block-button__link wp-element-button" style="background-color:#D8AEB7; color:#FFFFFF; padding:18px 50px; border-radius:50px; text-decoration:none; font-weight:bold; font-size:1.2rem; box-shadow:0 4px 15px rgba(216,174,183,0.4);" href="/1day-lesson">まずは1Day体験レッスンを見る</a></div>
<!-- /wp:button -->
</div>
<!-- /wp:buttons -->
...
<!-- wp:image {"align":"center"} -->
<figure class="wp-block-image aligncenter"><img src="https://mirii-sewing.online/wp-content/uploads/2026/03/IMG_1574-scaled.jpg" alt="レッスンの雰囲気が伝わる写真" style="max-width:100%; border-radius:12px; margin-bottom:30px; box-shadow:0 4px 10px rgba(0,0,0,0.05);"/></figure>
<!-- /wp:image -->
...
<!-- 特徴1 (#F8F5F2) -->
<!-- wp:group {"layout":{"type":"constrained","contentSize":"800px"}} -->
<div class="wp-block-group" style="background-color:#F8F5F2; padding:60px 20px; margin-bottom:40px; border-radius:20px;">
<!-- wp:heading {"level":2} -->
<h2 class="wp-block-heading" style="color:#333333; font-size:1.5rem; border-bottom:2px solid #F4DFE3; padding-bottom:10px; margin-bottom:30px;">1. 順序立てて進めるから、迷いにくい</h2>
<!-- /wp:heading -->
<!-- wp:paragraph -->
<p style="color:#4A4A4A; margin-bottom:25px; line-height:1.8;">初心者さんが止まりやすい理由のひとつは、<br>「何からやればいいのか分からない」ことです。</p>
<!-- /wp:paragraph -->
<!-- wp:paragraph -->
<p style="color:#4A4A4A; margin-bottom:25px; line-height:1.8;">mirii sewing では、<br>服作りに必要な流れを一つずつ整理しながら進めていきます。</p>
<!-- /wp:paragraph -->

<div style="background-color:#FFFFFF; padding:25px; border-radius:12px; margin-bottom:25px;">
<!-- wp:list -->
<ul class="wp-block-list" style="color:#4A4A4A; margin:0; padding-left:1.2em; line-height:2;">
<li>何を先にやるのか</li>
<li>どこでつまずきやすいのか</li>
<li>どう進めれば混乱しにくいのか</li>
</ul>
<!-- /wp:list -->
</div>
...
<div class="wp-block-group" style="background-color:#FFFFFF; padding:40px 20px; margin-bottom:40px;">
<!-- wp:heading {"level":2} -->
<h2 class="wp-block-heading" style="color:#333333; font-size:1.5rem; border-bottom:2px solid #F4DFE3; padding-bottom:10px; margin-bottom:30px;">2. 縫う前の準備から、大切にしています</h2>
<!-- /wp:heading -->
<!-- wp:paragraph -->
...
<!-- /wp:paragraph -->
<!-- wp:paragraph -->
<p style="color:#4A4A4A; margin-bottom:30px; line-height:1.8;">mirii sewing では、<br>そうした「最初の準備」から大切にしています。</p>
<!-- /wp:paragraph -->

<!-- wp:image {"align":"center"} -->
<figure class="wp-block-image aligncenter"><img src="https://mirii-sewing.online/wp-content/uploads/2026/03/IMG_4814-scaled.jpg" alt="縫う前の準備の様子" style="max-width:100%; border-radius:12px; margin-bottom:30px; box-shadow:0 4px 10px rgba(0,0,0,0.05);"/></figure>
<!-- /wp:image -->
...
<div class="wp-block-group" style="background-color:#F8F5F2; padding:60px 20px; margin-bottom:40px; border-radius:20px;">
<!-- wp:heading {"level":2} -->
<h2 class="wp-block-heading" style="color:#333333; font-size:1.5rem; border-bottom:2px solid #F4DFE3; padding-bottom:10px; margin-bottom:30px;">3. 少人数だから、分からないまま終わりにしません</h2>
<!-- /wp:heading -->
<!-- wp:paragraph -->
...
<div style="background-color:#FFFFFF; padding:25px; border-radius:12px; margin-bottom:25px;">
<!-- wp:list -->
<ul class="wp-block-list" style="color:#4A4A4A; margin:0; padding-left:1.5em; line-height:2;">
<li>糸のかけ方で止まっている</li>
<li>手元で何が分からなくなっている</li>
<li>質問したいけれど言いづらい</li>
</ul>
<!-- /wp:list -->
</div>
...
<div class="wp-block-group" style="background-color:#FFFFFF; padding:40px 20px; margin-bottom:40px;">
<!-- wp:heading {"level":2} -->
<h2 class="wp-block-heading" style="color:#333333; font-size:1.5rem; border-bottom:2px solid #F4DFE3; padding-bottom:10px; margin-bottom:30px;">4. 教室で終わらず、お家でも続けられることを目指します</h2>
<!-- /wp:heading -->
<!-- wp:paragraph -->
...
<div class="wp-block-group" style="background-color:#F8F5F2; padding:60px 20px; margin-bottom:40px; border-radius:20px;">
<!-- wp:heading {"level":2} -->
<h2 class="wp-block-heading" style="color:#333333; font-size:1.5rem; border-bottom:2px solid #F4DFE3; padding-bottom:10px; margin-bottom:30px;">5. 初心者さんの気持ちを前提にしたレッスンです</h2>
<!-- /wp:heading -->
<!-- wp:paragraph -->
...
<!-- wp:list -->
<ul class="wp-block-list" style="color:#4A4A4A; margin:0; padding-left:1.5em; line-height:2;">
<li>家庭科以来ミシンに触っていない</li>
<li>ミシンを買ったけれど使わないまま</li>
...
<!-- wp:paragraph {"align":"center"} -->
<p class="has-text-align-center" style="color:#D8AEB7; font-size:1.5rem; font-weight:bold; margin-bottom:10px;">完成より、習得。</p>
<!-- /wp:paragraph -->
<!-- wp:paragraph {"align":"center"} -->
<p class="has-text-align-center" style="color:#D8AEB7; font-size:1.5rem; font-weight:bold; margin-bottom:40px;">依存より、自立。</p>
<!-- /wp:paragraph -->
...
<!-- /wp:paragraph -->
<!-- wp:paragraph {"align":"left"} -->
<p style="color:#4A4A4A; line-height:1.8; margin-bottom:30px;">そのために、<br>分からないまま進めないこと、<br>順序立てて伝えること、<br>できるだけ自分で理解しながら手を動かせることを大切にしています。</p>
<!-- /wp:paragraph -->

<!-- wp:paragraph {"align":"center"} -->
<p class="has-text-align-center" style="color:#4A4A4A; font-weight:bold; font-size:1.2rem; line-height:1.8;">「先生がいないと作れない」<br>ではなく、<br>「次も自分でやってみよう」<br>と思えるようになることを目指しています。</p>
<!-- /wp:paragraph -->
</div>
<!-- /wp:group -->
...
<!-- こんな方に向いています (#FCF7F8) -->
<!-- wp:group {"layout":{"type":"constrained","contentSize":"800px"}} -->
<div class="wp-block-group" style="background-color:#FCF7F8; padding:60px 20px; margin-bottom:40px; border-radius:20px;">
<!-- wp:heading {"level":2} -->
...
<!-- wp:list -->
<ul class="wp-block-list" style="color:#4A4A4A; margin:0; padding-left:1.5em; line-height:2.2;">
...
<!-- wp:paragraph -->
<p style="color:#4A4A4A; margin-bottom:20px; line-height:1.8;">「自分に合うか分からない」<br>「いきなり継続コースは不安」</p>
<!-- /wp:paragraph -->
<!-- wp:paragraph -->
...
<!-- wp:image {"align":"center"} -->
<figure class="wp-block-image aligncenter"><img src="https://mirii-sewing.online/wp-content/uploads/2026/03/IMG_2713-scaled.jpg" alt="体験レッスンのイメージ" style="max-width:100%; border-radius:12px; margin-bottom:30px; box-shadow:0 4px 10px rgba(0,0,0,0.05);"/></figure>
<!-- /wp:image -->
...
<!-- /wp:paragraph -->
<!-- wp:paragraph -->
<p style="color:#4A4A4A; margin-bottom:0; line-height:1.8;">そのうえで、<br>もっと身につけたいと感じた方に、<br>継続コースをご案内しています。</p>
<!-- /wp:paragraph -->
...
<!-- wp:paragraph {"align":"center"} -->
<p class="has-text-align-center" style="color:#4A4A4A; margin-bottom:30px; line-height:1.8;">教室の特徴を読んで、<br>「自分にもできるかもしれない」を感じていただけたら、<br>最初の一歩として十分です。</p>
<!-- /wp:paragraph -->
...
<div class="wp-block-group" style="text-align:center;">
    ...
    <div class="wp-block-button" style="margin-bottom:25px;">
        <a class="wp-block-button__link wp-element-button" style="background-color:#D8AEB7; color:#FFFFFF; padding:20px 50px; border-radius:50px; text-decoration:none; font-weight:bold; font-size:1.2rem; display:inline-block; width:100%; max-width:400px; box-shadow:0 6px 15px rgba(216,174,183,0.4);" href="/1day-lesson">1Day体験レッスンの詳細を見る</a>
    </div>
    <!-- /wp:button -->
    ...
    <div class="wp-block-button">
        <a class="wp-block-button__link wp-element-button" style="background-color:#FFFFFF; color:#7FAE9B; padding:15px 40px; border-radius:50px; text-decoration:none; font-weight:bold; font-size:1.1rem; display:inline-block; width:100%; max-width:400px; border:2px solid #7FAE9B;" href="#">公式LINEで最新情報を受け取る</a>
    </div>
    <!-- /wp:button -->
</div>
<!-- /wp:group -->
